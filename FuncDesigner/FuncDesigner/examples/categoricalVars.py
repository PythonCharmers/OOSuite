...
constraints = [
               ...
               # we can use IMPLICATION as method:
               # suppose only Ivchenko AI-14 and MotorSich MD-18T can use fuel with octane number < 50:
               (FuelOctaneNumber < 50).IMPLICATION((engine == 'MotorSich MS400') | (engine == 'MotorSich MD-18T')), 
...
#p = NLP(annualProfit, startPoint, constraints = constraints, goal = 'max', fTol = 0.5, implicitBounds = (1, 2000))
...
objectives = [
              ...
              annualProfit, 0.1,'max', 
              initialPayment, 0.1, 'min'
              ]  
...
Solver:   Time Elapsed = 8.36 	CPU Time Elapsed = 8.2
Plotting: Time Elapsed = 6.17 	CPU Time Elapsed = 4.17
3 solutions have been obtained
'''
