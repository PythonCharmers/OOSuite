...
solver='scipy_fsolve' # set it to scipy_fsolve to ensure that the solver cannot handle the system
p = NLSP(F, startPoint, ftol = 1e-15, iterObjFunTextFormat='%0.9e' , iprint = 10)
