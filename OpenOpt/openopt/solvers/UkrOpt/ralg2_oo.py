...
#        B_constr = diag(ones(n))
        ...
        moveDirection = g
        minRegisteredDilatedVectorNorm = p.norm(g)
...
#        else: b = B_constr
        ...
        for itn in xrange(1500000):
            ...
            ng1 = p.norm(g1)
            if minRegisteredDilatedVectorNorm > 1.1*ng1 :
                minRegisteredDilatedVectorNorm = ng1
                # TODO: handle hs change here?
            g1 *= minRegisteredDilatedVectorNorm/ng1
