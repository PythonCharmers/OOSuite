'''
Simple OpenOpt dominating set problem example;
...
p = DSP(G) # you can use parameters "excludedNodes" and "includedNodes", e.g.
#includedNodes = [1, 5, 8], excludedNodes = [0, 4, 10])
# or 
# p = DSP(G, includedNodes = ['a1', 'c3'], excludedNodes = ['qwerty1'])
...
r = p.solve('glpk', iprint=0) # see http://openopt.org/MILP for other MILP solvers available in OpenOpt
...
'''
Solver:   Time Elapsed = 0.08 	CPU Time Elapsed = 0.04
